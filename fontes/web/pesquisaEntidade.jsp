...
<table width="591" border="0" align="center" cellpadding="1" cellspacing="1">
    ...
    <td width="587" height="133" valign="top"><table width="587" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="563"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="78%" class="titTab">ENTIDADE</td>
      ...
      <tr>
        ...
        <td width="560" height="332" valign="top"><table width="560" border="0" align="center" cellpadding="1" cellspacing="1" class="borda">
          <tr class="titGrid">
            <td colspan="2">LISTAR ENTIDADE</td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td width="474" height="266" valign="top"><table width="400" border="0" cellspacing="1" cellpadding="1">
  ...
  %>
    ...
    %>
	<logic:present name="certdigitalForm" property="entidadeHelper.entidadeVO.listaItemEntidadeVO">
      <logic:iterate name="certdigitalForm" property="entidadeHelper.entidadeVO.listaItemEntidadeVO" id="lista">

              
              <tr align="left" class=<%=classCSS%> >
                <td width="49" align="center"><a href="manutencaoEntidade.do?metodo=pesquisarEntidade&entidadeHelper.entidadeVO.itemEntidadeVO.idEntidade=<bean:write name="lista" property="idEntidade" />"><bean:write name="lista" property="idEntidade" /></a></td>
