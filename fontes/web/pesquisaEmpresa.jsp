...
<html:form action="pesquisaEmpresa.do" >
    ...
    <td width="587" height="133" valign="top"><table width="587" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="563"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
                <td width="78%" class="titTab"> EMPRESA </td>
      ...
      <tr>
        ...
        <td width="560" height="332" valign="top"><table width="560" border="0" align="center" cellpadding="1" cellspacing="1" class="borda">
          <tr class="titGrid">
                <td colspan="2">PESQUISAR EMPRESA</td>
          </tr>
          <tr>
            <td colspan="2" class="fontLogin"><table width="543" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr class="linhaGrid1">
                  ...
                  <td class="fontVerdana"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td width="14%">
                      <html:text property="empresaHelper.empresaVO.idEmpresa" styleClass="textsField" size="10" onkeyup="this.value = this.value.toUpperCase()" readonly="false" />
                      </td>
                      <td width="2%"> - </td>
                      <td width="34%">                      
                      <html:text property="empresaHelper.empresaVO.nomeComercial" styleClass="textsField" size="10" onkeyup="this.value = this.value.toUpperCase()" readonly="true" style="width:150px" readonly="true" />
                      </td>
                      <td width="50%" valign="middle">
                        <%
		       		      if (operador.getMenuGerencialVO().isConsultarEmpresa()) {
                	  	%>
                      	<a href="javascript:pesquisar('pesquisarEmpresas','empresaHelper.empresaVO.idEmpresa','empresaHelper.empresaVO.nomeComercial','EMPRESA')" >
                ...
                <tr class="linhaGrid">
                      <td class="fontLogin">CNPJ :</td>
                  <td class="fontVerdana"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td width="14%">
                      <html:text property="empresaHelper.empresaVO.numCNPJ" styleClass="textsField" size="14" onkeyup="this.value = this.value.toUpperCase()" readonly="false" />
                      </td>
                    </tr>
                  </table></td>
                </tr>
