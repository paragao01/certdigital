...
<html:form action="pesquisaPreco.do" >
    ...
    <td width="587" height="133" valign="top"><table width="587" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td width="560" height="332" valign="top"><table width="560" border="0" align="center" cellpadding="1" cellspacing="1" class="borda">
          <tr class="titGrid">
                <td colspan="2">PESQUISAR PRE&Ccedil;O</td>
          </tr>
          <tr>
            <td colspan="2" class="fontLogin"><table width="543" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr class="linhaGrid">
                  ...
                  <td class="fontVerdana"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td width="14%">
                      <html:text property="precoHelper.precoVO.idEmpresa" styleClass="textsField" size="10" onkeyup="this.value = this.value.toUpperCase()" readonly="false" styleId="N|S|10|Codigo Empresa|N" />
                      </td>
                      <td width="2%"> - </td>
                      <td width="34%">                      
                      <html:text property="precoHelper.precoVO.nomeEmpresa" styleClass="textsField" size="10" readonly="false" style="width:150px" />
                      </td>
                ...
                <tr class="linhaGrid1">
                  ...
                  <td class="fontVerdana"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td width="14%">
                      <html:text property="precoHelper.precoVO.idProduto" styleClass="textsField" size="10" onkeyup="this.value = this.value.toUpperCase()" readonly="false" styleId="N|N|10|Codigo Produto|N" />
                      </td>
                      <td width="2%"> - </td>
                      <td width="34%">                      
                      <html:text property="precoHelper.precoVO.nomeProduto" styleClass="textsField" size="10" readonly="false" style="width:150px" />
                      </td>
                      <td width="50%" valign="middle">
                        <%
