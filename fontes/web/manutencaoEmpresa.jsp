...
<html:form action="manutencaoEmpresa.do" >
  <html:hidden property="metodo" />
  <html:hidden property="empresaHelper.empresaVO.idEmpresa" />  
  <html:hidden property="empresaHelper.empresaVO.idEntidade" />  
        ...
        <td width="10" height="257" class="bgLeft">&nbsp;</td>
          <td width="560" height="332" valign="top"><table width="560" border="0" align="center" cellpadding="1" cellspacing="1" class="borda">
              ...
              <tr class="linhaGrid1"> 
                ...
                <bean:write name="certdigitalForm" property="empresaHelper.empresaVO.idEmpresa" />
                </td>
              </tr>
              <tr class="linhaGrid"> 
              ...
              <tr class="linhaGrid"> 
                ...
                <td colspan="3">
                	<html:text property="empresaHelper.empresaVO.dddFone" styleId="N|S|3|DDD Telefone|N" styleClass="textsField" size="5" maxlength="3" onblur="this.value = this.value.toUpperCase()"/>
                  	- 
                	<html:text property="empresaHelper.empresaVO.numFone" styleId="N|S|9|Telefone|N" styleClass="textsField" size="9" maxlength="11" onblur="this.value = this.value.toUpperCase()"/>
                </td>
              </tr>
              <tr class="linhaGrid1"> 
                ...
                <td colspan="3">
                	<html:text property="empresaHelper.empresaVO.dddFax" styleId="N|S|3|DDD Fax|N" styleClass="textsField" size="5" maxlength="3" onblur="this.value = this.value.toUpperCase()"/>
                  	- 
                	<html:text property="empresaHelper.empresaVO.numFax" styleId="N|S|9|Fax|N" styleClass="textsField" size="9" maxlength="9" onblur="this.value = this.value.toUpperCase()"/>
                </td>
              </tr>
              <tr class="linhaGrid"> 
