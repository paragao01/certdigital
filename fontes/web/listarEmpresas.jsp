    ...
    <td width="587" height="133" valign="top"><table width="587" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td width="560" height="332" valign="top"><table width="560" border="0" align="center" cellpadding="1" cellspacing="1" class="borda">
          <tr class="titGrid">
                <td colspan="2">LISTAR EMPRESA</td>
          </tr>
          <tr>
          ...
          <tr>
  		  ...
  		  %>
  		  <logic:present name="certdigitalForm" property="empresaHelper.listaEmpresaVO">
      		<logic:iterate name="certdigitalForm" property="empresaHelper.listaEmpresaVO" id="lista">
              <tr align="left" class=<%=classCSS%> >
                <td width="49" align="right"><a href="manutencaoEmpresa.do?metodo=prepararFiltro&empresaHelper.empresaVO.idEntidade=<bean:write name="lista" property="idEntidade" />&empresaHelper.empresaVO.idEmpresa=<bean:write name="lista" property="idEmpresa" />"><bean:write name="lista" property="idEmpresa" /></a></td>
                <td width="331"><bean:write name="lista" property="nomeComercial" /></td>
				<td width="200"><bean:write name="lista" property="nomeContato" /></td>                
              </tr>
          <%
