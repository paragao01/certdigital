...
<script>
<jsp:include page="SCRIPT/js_manutencaoProduto.jsp" /> 
</script>
...
<html:form action="manutencaoProduto.do" >
  <html:hidden property="metodo" />
  <html:hidden property="produtoHelper.produtoVO.idProduto" />  
  ...
  <tr>
    <td width="587" height="133" valign="top"><table width="587" border="0" cellspacing="0" cellpadding="0">
        ...
        <td width="563"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
                <td width="78%" class="titTab">PRODUTO MANUTEN&Ccedil;&Atilde;O</td>
        ...
        <td width="10" height="257" class="bgLeft">&nbsp;</td>
          <td width="560" height="332" valign="top" class="fontLogin">
			<table width="560" border="0" align="center" cellpadding="1" cellspacing="1" class="borda">
			  ...
			  <logic:notEqual name="certdigitalForm" property="produtoHelper.produtoVO.idProduto" value="" >
              	<tr class="linhaGrid"> 
                	<td width="140" class="fontLogin">C&oacute;digo</td>
                	<td width="411" colspan="3">
                	<bean:write name="certdigitalForm" property="produtoHelper.produtoVO.idProduto" />
                	</td>
              	</tr>			  
			  </logic:notEqual>
              <tr class="linhaGrid1"> 
              ...
              <tr class="linhaGrid"> 
                ...
                <td colspan="3">
                <html:select name="certdigitalForm" property="produtoHelper.produtoVO.pessoaProduto" styleClass="lists" styleId="S|S||Produto Pessoa|N">
