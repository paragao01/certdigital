  ...
  <tr>
    <td width="587" height="133" valign="top"><table width="587" border="0" cellspacing="0" cellpadding="0">
        ...
        <td width="563"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
                <td width="78%" class="titTab">PRE&Ccedil;O INCLUS&Atilde;O</td>
          ...
          <td width="560" height="332" valign="top" class="fontLogin">
			<table width="560" border="0" align="center" cellpadding="1" cellspacing="1" class="borda">
              ...
              <tr class="linhaGrid"> 
                ...
                <td colspan="3">
                  <html:text property="precoHelper.precoVO.idEmpresa" styleClass="textsField" size="10" onkeyup="this.value = this.value.toUpperCase()" readonly="true" styleId="N|S|10|Codigo Empresa|N" />
                  -
				  <html:text property="precoHelper.precoVO.nomeEmpresa" styleClass="textsField" size="10" readonly="true" style="width:150px" />
				  <%
		       		if (operador.getMenuGerencialVO().isConsultarEmpresa()) {
                  %>
				  <a href="javascript:pesquisar('pesquisarEmpresas','precoHelper.precoVO.idEmpresa','precoHelper.precoVO.nomeEmpresa','EMPRESA')" ><img src="_img/_bts/lupa.gif" width="18" height="16" border="0"></a>
				  <%
			   		}
  			 	  %>
                </td>
              ...
              <tr class="linhaGrid1"> 
                <td class="fontLogin">Produto:</td>
                <td class="fontVerdana">
                  <html:text property="precoHelper.precoVO.idProduto" styleClass="textsField" size="10" onkeyup="this.value = this.value.toUpperCase()" readonly="true" styleId="N|N|10|Codigo Produto|N" />
                  -
				  <html:text property="precoHelper.precoVO.nomeProduto" styleClass="textsField" size="10" readonly="true" style="width:150px" />
				  <%
					if (operador.getMenuGerencialVO().isConsultarProduto()) {
  				  %>
                  <a href="javascript:pesquisar('pesquisarProdutos','precoHelper.precoVO.idProduto','precoHelper.precoVO.nomeProduto','PRODUTO','precoHelper.precoVO.idEmpresa','Empresa')" ><img src="_img/_bts/lupa.gif" width="18" height="16" border="0"></a>
                  <%
					}
  				  %>
                </td>
              ...
              <tr class="linhaGrid1"> 
                <td width="140" class="fontLogin">Data Refer&ecirc;cia:</td>
