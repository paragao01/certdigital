    ...
    <td width="587" height="133" valign="top"><table width="587" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td width="560" height="332" valign="top"><table width="560" border="0" align="center" cellpadding="1" cellspacing="1" class="borda">
          <tr class="titGrid">
                <td colspan="2">LISTAR CERTIFICADO</td>
          </tr>
          <tr>
            <td colspan="2" class="fontLogin"><table width="543" border="0" cellspacing="0" cellpadding="0">
                <tr>
                      <td width="76" class="fontLogin">&nbsp;</td>    <td width="452" class="fontVerdana">&nbsp;</td>
                </tr>
            </table></td>
          </tr>
          <tr>
            <td width="75" height="266">&nbsp;</td>
            <td width="674" height="266" valign="top"><table width="600" border="0" cellspacing="1" cellpadding="1">
              <tr class="subTextoAviso">
                <td width="49"><div align="left">C&Oacute;DIGO</div></td>
                <td><p align="left">DOCUMENTO</p></td>
                <td><p align="left">RAZ&Atilde;O SOCIAL</p></td>
                <td><p align="left">DATA EMISS&Atilde;O</p></td>                
          	  </tr>
  		  <% 
    	  int i=0;
		  ...
		  if (operador.getMenuOperacionalVO().isConsultarCertificado()) {
  		  %>
  		  <logic:present name="certdigitalForm" property="certificadoHelper.listaCertificadoVO">
      		<logic:iterate name="certdigitalForm" property="certificadoHelper.listaCertificadoVO" id="lista">
              <tr align="left" class=<%=classCSS%> >
                <td width="49" align="right"><a href="manutencaoCertificado.do?metodo=prepararFiltro&certificadoHelper.certificadoVO.idEntidade=<bean:write name="lista" property="idEntidade" />&certificadoHelper.certificadoVO.idEmpresa=<bean:write name="lista" property="idEmpresa" />&certificadoHelper.certificadoVO.idCertificado=<bean:write name="lista" property="idCertificado" />"><bean:write name="lista" property="idCertificado" /></a></td>
                <logic:equal name="lista" property="tipo_pessoa" value="F">
                	<td width="130">CPF:<bean:write name="lista" property="documentoAsString" /></td>
                </logic:equal>
                <logic:equal name="lista" property="tipo_pessoa" value="J">
                	<td width="130">CNPJ:<bean:write name="lista" property="documentoAsString" /></td>
                </logic:equal>                
				<td width="400"><bean:write name="lista" property="razaoRequerente" /></td>
   				<td width="100"><bean:write name="lista" property="dataEmissaoAsString" /></td>
              </tr>
          	  <%
