...
<html:form action="incluirProduto.do" >
  ...
  <tr>
    <td width="587" height="133" valign="top"><table width="587" border="0" cellspacing="0" cellpadding="0">
        ...
        <td width="563"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
                <td width="78%" class="titTab">PRODUTO INCLUS&Atilde;O</td>
          ...
          <td width="560" height="332" valign="top" class="fontLogin">
			<table width="560" border="0" align="center" cellpadding="1" cellspacing="1" class="borda">
              ...
              <tr class="linhaGrid"> 
                ...
                <td colspan="3">
                  <html:text property="produtoHelper.produtoVO.idEmpresa" styleClass="textsField" size="10" onkeyup="this.value = this.value.toUpperCase()" readonly="true" styleId="N|S|10|Codigo Empresa|N" />
                  -
				  <html:text property="produtoHelper.produtoVO.nomeEmpresa" styleClass="textsField" size="10" readonly="true" style="width:150px" />
				  <%
		       		if (operador.getMenuGerencialVO().isConsultarProduto()) {
                  %>
				  <a href="javascript:pesquisar('pesquisarEmpresas','produtoHelper.produtoVO.idEmpresa','produtoHelper.produtoVO.nomeEmpresa','EMPRESA')" ><img src="_img/_bts/lupa.gif" width="18" height="16" border="0"></a>
				  <%
			   		}
  			 	  %>
                </td>
              ...
              <tr class="linhaGrid1"> 
                <td width="140" class="fontLogin">Descri&ccedil;&atilde;o:</td>
                <td width="411" colspan="3">
                <html:text property="produtoHelper.produtoVO.nomeProduto" styleId="S|S|50|Descricao" styleClass="textsField" style="width:150px" maxlength="50" onkeyup="this.value = this.value.toUpperCase()"/>
                </td>
              </tr>
              <tr class="linhaGrid"> 
                <td class="fontLogin">Tipo Produto:</td>
                <td colspan="3">
                      <html:text property="produtoHelper.produtoVO.tipoProduto" styleId="S|S|2|Tipo Produto" styleClass="textsField" style="width:20px" maxlength="2" onkeyup="this.value = this.value.toUpperCase()"/>
                
                </td>
              </tr>
              <tr class="linhaGrid1"> 
                <td class="fontLogin">Validade:</td>
                <td colspan="3">
                      <html:text property="produtoHelper.produtoVO.validadeProduto" styleId="S|S|1|Validade" styleClass="textsField" style="width:10px" maxlength="1" onkeyup="this.value = this.value.toUpperCase()"/>
                      &nbsp;Ano(s)
                </td>
              </tr>
              <tr class="linhaGrid"> 
                <td class="fontLogin">Produto Pessoa :</td>
                <td colspan="3">
                <html:select styleClass="lists" property="produtoHelper.produtoVO.pessoaProduto" styleId="S|S||Produto Pessoa" >
					<option value="">...</option>                
                  	<option value="<%=GlobalConstants.VALOR_FISICA%>"><%=GlobalConstants.LABEL_FISICA%></option>
                  	<option value="<%=GlobalConstants.VALOR_JURIDICA%>"><%=GlobalConstants.LABEL_JURIDICA%></option>                  	
       			</html:select>
              </tr>
              <tr> 
