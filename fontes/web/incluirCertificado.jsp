...
<html:form action="incluirCertificado.do" >
    ...
    <td width="587" height="133" valign="top"><table width="587" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="563"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="78%" class="titTab">CERTIFICADO INCLUS&Atilde;O</td>
        ...
        <td width="10" height="257" class="bgLeft">&nbsp;</td>
          <td width="560" height="332" valign="top"><table width="560" border="0" align="center" cellpadding="1" cellspacing="1" class="borda">
              ...
              <tr class="linhaGrid"> 
                ...
                <html:text property="certificadoHelper.certificadoVO.complementoResponsavel" styleId="S|N|50|Complemento|N" styleClass="textsField" style="width:200px" maxlength="50" onblur="this.value = this.value.toUpperCase()"/>
                </td>                
              </tr>
              <tr> 
                <td colspan="4" class="linhaGrid">&nbsp;</td>
              ...
              <tr class="linhaGrid"> 
                ...
                <html:select styleClass="lists" property="certificadoHelper.certificadoVO.associado" styleId="S|S||Associado|N" >
					<option value="">...</option>                
                  	<option value="<%=GlobalConstants.VALOR_FLAG_NAO%>"><%=GlobalConstants.LABEL_FLAG_NAO%></option>
                  	<option value="<%=GlobalConstants.VALOR_FLAG_SIM%>"><%=GlobalConstants.LABEL_FLAG_SIM%></option>                  	
       			</html:select>
                </td>                                            
              </tr>
              <tr> 
