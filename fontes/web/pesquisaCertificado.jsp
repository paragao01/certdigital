...
<html:form action="pesquisaCertificado.do" >
    ...
    <td width="587" height="133" valign="top"><table width="587" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="563"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
                <td width="78%" class="titTab"> CERTIFICADO </td>
      ...
      <tr>
        ...
        <td width="560" height="332" valign="top"><table width="560" border="0" align="center" cellpadding="1" cellspacing="1" class="borda">
          <tr class="titGrid">
                <td colspan="2">PESQUISAR CERTIFICADO</td>
          </tr>
          <tr>
            <td colspan="2" class="fontLogin"><table width="543" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr class="linhaGrid">
                  ...
                  <td class="fontVerdana"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td width="14%">
                      <html:text property="certificadoHelper.certificadoVO.idEmpresa" styleClass="textsField" size="10" onkeyup="this.value = this.value.toUpperCase()" readonly="false" />
                      </td>
                      <td width="2%"> - </td>
                      <td width="34%">                      
                      <html:text property="certificadoHelper.certificadoVO.fantasiaRequerente" styleClass="textsField" size="10" onkeyup="this.value = this.value.toUpperCase()" readonly="true" style="width:150px" readonly="true" />
                      </td>
                      <td width="50%" valign="middle">
                        <%
		       		      if (operador.getMenuOperacionalVO().isConsultarCertificado()) {
                	  	%>
                      	<a href="javascript:pesquisar('pesquisarEmpresas','certificadoHelper.certificadoVO.idEmpresa','certificadoHelper.certificadoVO.fantasiaRequerente','EMPRESA')" >
                ...
                <tr class="linhaGrid1">
                  <td class="fontLogin">Tipo Pessoa :</td>
                  <td class="fontVerdana"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td width="14%">
                		<html:select styleClass="lists" property="certificadoHelper.certificadoVO.tipo_pessoa" styleId="S|N||Tipo Pessoa|N" >
							<option value="">...</option>                
                ...
                <tr class="linhaGrid">
                  <td class="fontLogin">Documento :</td>
                  <td class="fontVerdana"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td width="14%">
                   		<html:text property="certificadoHelper.certificadoVO.documentoAsString" styleClass="textsField" style="width:100px" maxlength="18" onkeypress="return mascara(this, (document.forms[0].elements['certificadoHelper.certificadoVO.tipo_pessoa'].value=='F'?cpf:cnpj));" />                
                      </td>
                    </tr>
                  </table></td>
                </tr>                
            ...
            <td colspan="2"><table border="0" align="right" cellpadding="2" cellspacing="2">
                  <tr>
                     <%
		       		   if (operador.getMenuOperacionalVO().isConsultarCertificado()) {
                	 %>
                      <td><a href="javascript:pesquisaCertificado();"><img src="_img/_bts/pesquisar.gif" width="74" height="18" border="0"></a></td>
                     <%
			   		   }
  			 		 %>
                  </tr>
